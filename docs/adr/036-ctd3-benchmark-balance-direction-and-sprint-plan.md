...
| 7 (Cartographer editor) | **SHIPPED** (2026-07-23) | 7a via CH-6 `4e880b6` (note: undo/redo, keyboard bindings, import, autosave pre-dated this ledger — shipped as audit T19/T20); 7b via Sprint-2 W-1 `1008d8b` (responsive shell) + W-2 (theme-keyed WFC palettes, cabin-tone preview bg). ADR-034 fully closed. |
